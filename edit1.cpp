...
class STUDENT{
      ...
      void enter()
      {
           ...
           cout<<"\t\t\t       PHYSICS-2    : ";
           cin>>marks[0];
           cout<<"\t\t\t       SOFTWARE DEVELOPEMENT FUNDAMENTALS-2  : ";
           cin>>marks[1];
           cout<<"\t\t\t       MATHEMATICS-2: ";
           cin>>marks[2];
           cout<<"\t\t\t       ELECTRICAL SCIENCE-1   : ";
           cin>>marks[3];
           cout<<"\t\t\t       LIFE SKILLS    : ";
           cin>>marks[4];
           }
           ...
           cout<<"\t\t\t       PHYSICS-1    : ";
           cin>>marks[0];
           cout<<"\t\t\t       SOFTWARE DEVELOPEMENT FUNDAMENTALS-1  : ";
           cin>>marks[1];
           cout<<"\t\t\t       MATHEMATICS-1: ";
           cin>>marks[2];
           cout<<"\t\t\t       BRIDGE COURSE   : ";
      ...
      void display_report()
      {
           ...
           cout<<"                 ---------------------------------------\n";
           if (sem==2){
           cout<<"\t\t\t  PHYSICS-2\t"<<marks[0]<<"\n";
           cout<<"\t\t\t  SOFTWARE DEVELOPEMENT FUNDAMENTALS-2\t"<<marks[1]<<"\n";
           cout<<"\t\t\t  MATHEMATICS-2\t\t"<<marks[2]<<"\n";
           cout<<"\t\t\t  ELECTRICAL SCIENCE-1\t"<<marks[3]<<"\n";
           cout<<"\t\t\t  LIFE SKILLS\t"<<marks[4]<<"\n";
           }
           else if (sem==1){
           cout<<"\t\t\t  PHYSICS-1\t"<<marks[0]<<"\n";
           cout<<"\t\t\t  SOFTWARE DEVELOPEMENT FUNDAMENTALS-1\t"<<marks[1]<<"\n";
           cout<<"\t\t\t  MATHEMATICS-1\t\t"<<marks[2]<<"\n";
           cout<<"\t\t\t  BRIDGE COURSE\t"<<marks[3]<<"\n";
...
/******************SEARCHING FOR A RECORD (STUDENT)******************/
void search_student()
{
     STUDENT s;
     ifstream f("Record.dat");
...
void sortmark()
{
     ...
     else
     {
         ...
         cout<<"\t\t\t       1. PHYSICS-1"<<"\n\n";
         cout<<"\t\t\t       2. SDF-1"<<"\n\n";
         cout<<"\t\t\t       3. MATHEMATICS-1"<<"\n\n";
         cout<<"\t\t\t       4. BRIDGE COURSE"<<"\n\n";
         cout<<"\t\t\t       5. ENGLISH"<<"\n\n\n";
...
void Intro()
{
     cout<<"\n\n\n\n\n\n\n\n\n\n\n\t\tA PROGRAM BY VAISHALI GUPTA AND YASHIKA BISHT!!";
     Sleep(2000);
     system("cls");
     for(int i=1;i<=100;++i)
     {
...
void Segregation()
{
     ...
     cout<<"\t\t-------------------------------------------"<<"\n";
     cout<<"\t\t  1. PROFESSOR\t2. STUDENT\t3. PUBLIC"<<"\n";
     cout<<"\t\t-------------------------------------------"<<"\n\n";
...
int main()
{
     system("title GRADE CARD GENERATOR");
     system("COLOR F0");
     SEQUENCE();
     getch();
     return 0;
